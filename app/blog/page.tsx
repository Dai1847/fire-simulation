...
export const metadata: Metadata = {
    title: "FIRE・資産形成ブログ | Life Simulation Tools",
    description: "FIRE（経済的自立）、高配当株投資、新NISA、家計管理など、資産形成に役立つ知識を体系的に解説するブログです。シミュレーションツールと合わせて活用し、あなたの人生設計をサポートします。",
    keywords: ["FIRE", "資産形成", "高配当株", "新NISA", "節約", "シミュレーション"],
    openGraph: {
        title: "FIRE・資産形成ブログ | Life Simulation Tools",
        description: "FIRE、高配当株投資、新NISAなど、資産形成に役立つ知識を体系的に解説。人生設計をシミュレーションツールでサポートします。",
        type: "website",
    }
};
